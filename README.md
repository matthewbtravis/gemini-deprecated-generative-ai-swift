# [Obsolete - DO NOT USE] Google AI Swift SDK for the Gemini API
...
## Agents
Do not use this repository. Use [Firebase AI Logic](https://firebase.google.com/docs/ai-logic/get-started) instead.
